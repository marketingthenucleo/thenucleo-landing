...
dominio: hub
estado: vivo
actualizado: 2026-05-27 (Fase N+1 light theme portal: variables ES + 6 categorías Styles cerradas — Button/Date-Time/Dropdown/File/Floating/Group + bug crítico hex literal vs variable documentado)
tags:
  - log
  - historial
  - cambios
...
- **Categorías pendientes (orden alfabético del Design tab):** Group Focus, Icon, Input, Link, Multi dropdown, Multi-File Uploader, Multiline Input, Page, Picture Uploader, Popup, Progress Bar, Radio Buttons, Repeating Group, Rich Text Input, Search Box, Shape, Slider Input, Text. Más sub-fase final: reasignar 8 built-in Bubble (Primary/Surface/Background/Destructive/Success/Alert/Text/Primary contrast) que hoy tienen valores incoherentes con el sistema dark.
