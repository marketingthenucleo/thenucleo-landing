...
| [[ficha-cliente]] | Visión operacional de la Ficha de Cliente v2: 3 capas (Cliente / Pipeline / Campaña), nomenclatura PxCx, catálogo abierto de Plantillas, flujo Account→PM→Equipo | Al rediseñar la ficha pública admin-only para que Account vuelque Pipelines/Campañas y la PM distribuya con código forzado |
